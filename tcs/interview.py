...
# what are the oops principles? and folloup questions on ech polymorhpism, inheritence, encapsulation and abstraction
...
# asked to find element using ancestor element strategy
# what is the difference between selenium and playwright
# why are you looking for change etc..
# What are different exceptions you have come across
# What Stale Element Exception
# When Stale Element, No Such Element nad TImeoutExceptions comes
# findElement vs findElements
# As a lead how do you define timeline for given 1K test cases to automate
# if selnium click is not working what is the other way to achive it? - using javascript executor method
